...
//essa função irá corrigir para manter a propriedade da min-heap.
...
//reestabelecida. Caso a heap esteja vazia é exibida a mensagem de erro "Heap Overflow!" e a enqueue é encerrada.
